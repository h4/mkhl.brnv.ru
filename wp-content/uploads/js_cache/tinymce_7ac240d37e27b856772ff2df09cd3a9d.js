var tinyMCEPreInit = { settings : { themes : "advanced", plugins : "safari,inlinepopups,autosave,spellchecker,paste,wordpress,media,fullscreen,wpeditimage", languages : "ru", debug : false }, base : "http://designnotfound.ru/wp-includes/js/tinymce", suffix : "", query : "ver=311" };tinyMCEPreInit.start = function() {
...
clipboard_no_support:"В настоящее время ваш браузер не поддерживается, вместо этого используйте клавиатурные сочетания.",
popup_blocked:"Извините, но вы получили это сообщение, т.к. в ваш браузер заблокировал всплывающее окно, которое требуется для работы . Чтобы полноценно пользоваться этой функцией, вам нужно разрешить всплывающие окна для этого сайта.",
...
date_fmt:"%d.%m.%Y",
time_fmt:"%H:%M:%S",
insertdate_desc:"Вставить изображение",
...
day_long:"Воскресенье,Понедельник,Вторник,Среда,Четверг,Пятница,Суббота",
...
nonbreaking:{
nonbreaking_desc:"Вставить символ неразрывного пробела"
},
iespell:{
iespell_desc:"Проверить орфографию",
download:"ieSpell не обнаружен. Установить сейчас?"
},
advhr:{
...
acronym_desc:"Сокращение",
del_desc:"Удаление",
ins_desc:"Вставка",
attribs_desc:"Вставить/редактировать атрибуты"
},
style:{
desc:"Редактировать CSS"
},
paste:{
...
paste_dlg:{
text_title:"Используйте сочетание Ctrl+V, чтобы вставить текст в окно.",
text_linebreaks:"Сохранять разрывы строк",
word_title:"Используйте сочетание Ctrl+V, чтобы вставить текст в окно."
},
table:{
...
autosave:{
unload_msg:"Сделанные вами изменения будут отменены если вы уйдете с этой страницы."
},
fullscreen:{
desc:"Переключить полноэкранный режим (Alt+Shift+G)"
},
media:{
desc:"Вставить/редактировать медиафайл",
delta_width:"0",
delta_height:"0",
edit:"Редактировать медиафайл"
},
fullpage:{
desc:"Свойства документа"
},
template:{
desc:"Вставить содержимое готового шаблона"
},
visualchars:{
desc:"Включить/выключить символы визуального контроля."
},
spellchecker:{
desc:"Включить/выключить проверку орфографии (Alt+Shift+N)",
menu:"Настройки проверки орфографии",
ignore_word:"Пропустить слово",
ignore_words:"Пропустить все",
langs:"Языки",
wait:"Пожалуйста, подождите...",
sug:"Варианты",
no_sug:"Вариантов нет",
...
dd:"Описание термина",
bold_desc:"Жирный (Ctrl / Alt+Shift + B)",
italic_desc:"Курсив (Ctrl / Alt+Shift + I)",
underline_desc:"Подчёркнутый",
striketrough_desc:"Перечеркнутый (Alt+Shift+D)",
justifyleft_desc:"По левому краю (Alt+Shift+L)",
justifycenter_desc:"По центру (Alt+Shift+C)",
justifyright_desc:"По правому краю (Alt+Shift+R)",
justifyfull_desc:"По ширине (Alt+Shift+J)",
bullist_desc:"Маркированный список (Alt+Shift+U)",
numlist_desc:"Нумерованный список (Alt+Shift+O)",
outdent_desc:"Убрать отступ",
indent_desc:"Отступ",
undo_desc:"Отменить (Ctrl+Z)",
redo_desc:"Повторить (Ctrl+Y)",
link_desc:"Вставить/редактировать ссылку (Alt+Shift+A)",
link_delta_width:"0",
link_delta_height:"0",
unlink_desc:"Убрать ссылку (Alt+Shift+S)",
image_desc:"Вставить/редактировать изображение (Alt+Shift+M)",
image_delta_width:"0",
image_delta_height:"0",
cleanup_desc:"Привести код в порядок",
...
charmap_desc:"Вставить произвольный символ",
visualaid_desc:"Ориентиры / невидимые символы",
...
help_desc:"Помощь",
blockquote_desc:"Цитата (Alt+Shift+Q)",
clipboard_msg:"Копировать/Вырезать/Вставить недоступно в Mozilla и Firefox.",
path:"Путь",
newdocument:"Вы уверены, что хотите очистить всё содержимое?",
toolbar_focus:"Перейти к инструментам – Alt+Q, перейти к редактору – Alt+Z, перейти к пути элемента – Alt+X",
more_colors:"Больше цветов",
...
colorpicker_picker_tab:"Пипетка",
...
charmap_title:"Выберите произвольный символ",
...
image_vspace:"Отступ (верт)",
image_hspace:"Отступ (гориз)",
...
image_align_texttop:"Сверху текста",
image_align_textbottom:"Снизу текста",
image_align_left:"Слева",
image_align_right:"Справа",
link_title:"Вставить/редактировать ссылку",
link_url:"URL ссылки",
link_target:"Назначение",
link_target_same:"Открывать ссылку в текущем окне",
link_target_blank:"Открывать ссылку новом окне",
link_titlefield:"Заголовок",
link_is_email:"Введенный вами адрес похож на email, добавить префикс mailto: ?",
link_is_external:"Введённый вами адрес похож на внешнюю ссылку, добавить префикс http:// ?",
link_list:"Список ссылок"
});

tinyMCE.addI18n("ru.media_dlg",{
title:"Вставить/редактировать медиафайл",
general:"Общие",
...
flashvars:"Переменные Flashvars",
...
invokeurls:"Открывать ссылки (URL)",
mute:"Без звука",
stretchtofit:"Растянуть до размеров окна",
windowlessvideo:"Видео без окна",
balance:"Баланс",
baseurl:"Базовый URL",
captioningid:"Id титрования",
currentmarker:"Текущий маркер",
currentposition:"Текущая позиция",
defaultframe:"Кадр по умолчанию",
playcount:"Число показов",
rate:"Частота",
uimode:"Режим интерфейса",
flash_options:"Настройки Flash",
qt_options:"Настройки Quicktime",
wmp_options:"Настройки Windows media player",
rmp_options:"Настройки проигрывателя Real media",
shockwave_options:"Настройки Shockwave",
autogotourl:"Автопереход к URL",
center:"Центр",
imagestatus:"Статус изображения",
maintainaspect:"Сохранить пропорции",
nojava:"Без java",
prefetch:"Упреждающее кэширование",
shuffle:"Произвольный порядок",
console:"Консоль",
numloop:"Число повторов",
controls:"Управление",
scriptcallbacks:"Функции скриптов",
swstretchstyle:"Растянуть",
swstretchhalign:"Выравнивание по горизонтали",
swstretchvalign:"Выравнивание по  вертикали",
sound:"Звук",
progress:"Прогресс",
qtsrc:"Источник QT",
qt_stream_warn:"Потоковые ресурсы rtsp следует добавлять в поле Источник QT под вкладкой &laquo;Дополнительно&raquo;.",
align_top:"Сверху",
align_right:"Справа",
align_bottom:"Снизу",
align_left:"Слева",
...
flv_jscallback:"Функция JS"
});

tinyMCE.addI18n("ru.wordpress",{
wp_adv_desc:"Показать/скрыть дополнительную панель кнопок (Alt+Shift+Z)",
wp_more_desc:"Вставить тег &lt;Далее&gt; (Alt+Shift+T)",
wp_page_desc:"Вставить разрыв страницы (Alt+Shift+P)",
wp_help_desc:"Помощь (Alt+Shift+H)",
wp_more_alt:"Далее...",
wp_page_alt:"Следующая страница...",
...
tinyMCE.addI18n("ru.wpeditimage",{
edit_img:"Редактировать изображение",
del_img:"Удалить изображение",
adv_settings:"Расширенные настройки",
none:"Нет",
size:"Размер",
thumbnail:"Миниатюра",
medium:"Средний",
full_size:"Оригинал",
current_link:"Текущая ссылка",
link_to_img:"Ссылка на изображение",
link_help:"Введите URL ссылки или выберите выше из предустановок.",
adv_img_settings:"Расширенные настройки изображения",
source:"Исходник",
width:"Ширина",
height:"Высота",
orig_size:"Оригинальный размер",
css:"Класс CSS",
adv_link_settings:"Расширенные настройки ссылки",
link_rel:"Rel ссылки",
height:"Высота",
orig_size:"Оригинальный размер",
css:"Класс CSS",
...
s120:"120%",
s130:"130%",
img_title:"Редактировать заголовок изображения",
caption:"Редактировать подпись изображения",
alt:"Редактировать альтернативный текст"
});
